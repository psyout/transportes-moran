export const ServicesData = [
	...
	{
		title: 'Cama Baja',
		body: 'Las camas bajas son esenciales en la industria del transporte de carga pesada y son utilizadas por empresas de construcción, transporte especializado y logística para mover equipos grandes y pesados de manera segura y eficiente.',
		url: '#',
	...
	{
		title: 'Arriendo Maquinarias',
		body: ' Arriendo de equipos y maquinaria pesada por un período determinado, en lugar de comprarlos. Esto se utiliza comúnmente en la industria de la construcción, la minería, la agricultura y otros sectores que requieren el uso de maquinaria especializada de manera temporal o intermitente. ',
		url: '#',
		imagen: require('../../assets/images/svg/arriendo.svg'),
	},
];
